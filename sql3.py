...
# CodeGrade step3
# Replace None with your code
df_employee = df_contacts = pd.read_sql("""
SELECT 
    c.contactFirstName,
    c.contactLastName,
    c.phone,
...
# CodeGrade step4
# Replace None with your code
df_contacts = df_payment = pd.read_sql("""
SELECT 
    c.contactFirstName,
    c.contactLastName,
    p.amount,
...
JOIN customers c
    ON e.employeeNumber = c.salesRepEmployeeNumber
JOIN orderDetails od    
ON c.customerNumber = od.orderNumber
JOIN products p
